...
const transactionController = new controller_1.EmployeeCustomerTransactionController();
 ...
 */
router.get("/transactions", validateToken.validate, (req, res) => transactionController.getAllTransactions(req, res));
/**
 ...
 * @requires Authorization: Bearer <token>
 */
router.get("/transactions/date-range", validateToken.validate, (req, res) => transactionController.getTransactionsByDateRange(req, res));
/**
 ...
 * @requires Authorization: Bearer <token>
 */
router.get("/transactions/:id", validateToken.validate, (req, res) => transactionController.getTransactionById(req, res));
/**
 ...
 * @requires Authorization: Bearer <token>
 */
router.post("/transactions", validateToken.validate, (req, res) => transactionController.createTransaction(req, res));
/**
 ...
 * }
 */
router.post("/transactions/batch", validateToken.validate, (req, res) => transactionController.createBatchTransactions(req, res));
/**
 ...
 * @requires Authorization: Bearer <token>
 */
router.put("/transactions/:id", validateToken.validate, (req, res) => transactionController.updateTransaction(req, res));
/**
 ...
 * @requires Authorization: Bearer <token>
 */
router.delete("/transactions/:id", validateToken.validate, (req, res) => transactionController.deleteTransaction(req, res));
