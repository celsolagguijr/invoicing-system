...
const drawPaymentFooter = (
  ...
  doc
    ...
    .fontSize(8)
    .text(
      "Please pay the amount to Bank of Butterfield KYD Chequing Account #1361665040016/Dolor Pascual",
      left,
      yStart + 4,
      { width, align: "center" },
    )
    .text(
      "Please pay the amount to CNB Bank KYD Chequing Account #01113979/Dolor Pascual",
      left,
      yStart + 20,
      { width, align: "center" },
    )
    ...
    .text(
      "Please pay the amount to Bank of Butterfield USD Chequing Account #8401665040028/Dolor Pascual",
      left,
      yStart + 52,
      { width, align: "center" },
    )
    .text(
      "If you prefer to pay by cheque, please make it payable to Dolor Pascual, and kindly let us know how we can collect.",
      left,
      yStart + 68,
      { width, align: "center" },
    );
...
export const generateInvoicePdfBuffer = (invoice: Invoice): Promise<Buffer> => {
  return new Promise((resolve, reject) => {
    ...
    doc
      ...
      .text(
        "P.O BOX 30788, KY1-1204 GRAND CAYMAN, CAYMAN ISLANDS",
        left,
        y + 14,
        {
          width: 515,
      ...
      .text(
        "Website: www.ghcaregroup.ky; Email: ghcaregroup345@gmail.com",
        left,
        y + 54,
        {
          width: 515,
    ...
    invoice.invoice_details.forEach((detail) => {
      ...
      const rowAmount =
        billedHours * Number(invoice.hourly_rate || 0) +
    ...
    doc
      ...
      .fillColor("#111827")
      .text(
        `OT Rate Per Hour: KYD ${formatMoney(displayOtRate)}`,
        left,
        summaryY + 14,
        {
          width: 260,
